...
**File with ancestry labels assignment for each sample**: [Population_Sample_Info.txt](https://raw.githubusercontent.com/joellembatchou/SISG2023_Association_Mapping/master/data/Population_Sample_Info.txt) 
