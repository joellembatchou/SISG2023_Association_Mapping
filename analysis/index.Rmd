...
" ",#    paste0(print.link("HTML", "Session07_practical_Key.html"), ", ", print.link("Rmd", "")),
" " #    paste0(print.link("HTML", "Session08_practical_Key.html"), ", ", print.link("Rmd", ""))
  )
  , check.names = FALSE) %>%
knitr::kable("html", escape = FALSE, 
...
data.frame(
  ...
  Lecture = c(
    paste0(print.link("Lecture", "https://www.dropbox.com/scl/fi/3gre44f5kkiu8offry1vp/SISGM15_prac9Solution.Rmd?rlkey=9v7qvshezy2bxf5h952jfm1ab&dl=0")),
    "Lecture" 
      ),
  "Exercises" = c(
  ...
  "Key" = c(
   " ",# paste0(print.link("HTML", "SISGM15_prac9Solution.html"), ", ", print.link("Rmd", "")),
    " "
  )
  , check.names = FALSE) %>%
knitr::kable("html", escape = FALSE, 
